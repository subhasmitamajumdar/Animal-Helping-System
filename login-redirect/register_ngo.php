...
<html>
    ...
    <tr><td colspan="2"></td><td ><?php if($errWebsite!==""){?><div class="msg"><?php echo $errWebsite;}?></div></td></tr>
...
if($_SESSION['o2flag']===true)
    ...
    <tr ><td colspan="5"><input type ="submit" name="tovet" value="Veterinary Registration"></td> </tr>
